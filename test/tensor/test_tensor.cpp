...
TEST(TensorTestDouble, GetLinearIndex4D_NCHW) {
  ...
  Tensor<double> t({2, 3, 4, 5}, Layout::NCHW);
...
TEST(TensorTestDouble, GetLinearIndex4D_NHWC) {
  ...
  Tensor<double> t({2, 3, 4, 5}, Layout::NHWC);
...
TEST(TensorTestDouble, GetLinearIndex4D_ND) {
  ...
  Tensor<double> t4d_nd({2, 3, 4, 5}, Layout::ND);
...
TEST(TensorTestDouble, GetLinearIndex_OutOfBounds) {
  ...
  Tensor<double> t2d({2, 3}, Layout::ND);
  Tensor<double> t4d_nchw({2, 3, 4, 5}, Layout::NCHW);
  Tensor<double> t4d_nhwc({2, 3, 4, 5}, Layout::NHWC);
  Tensor<double> t4d_nd({2, 3, 4, 5}, Layout::ND);
